...
url = "https://wa.me/918618948661?text="+urllib.parse.quote_plus("I have registered!")
link = url_shortener_fn(url)
old_reg_sms = "[COVIDSOS] You are already registered. We have updated your info. Click here to contact us "+link
...
link = url_shortener_fn(url)
new_request_sms = "[COVIDSOS] {name}, we have received your request via {source}. We will call you soon. If urgent, please click "+ link
...
mod_url = "https://covidsos.org/verify/{uuid}"
new_request_mod_sms = "New query received from {source}. Verify lead by clicking here: " + mod_url
